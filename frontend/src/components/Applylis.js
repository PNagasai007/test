  ...
  const clickHandler = async (e) => 
    {
        ...
        formData.append("myFile",pfile);
          // pfile.name
        // console.log(formData);
     try {
      // setafile(URL.createObjectURL(e.target.files[0]));
        ...
        <form>
          <div className="mb-3" onChange={(e) => {setname(e.target.value)}}>
            ...
            <div className="mb-3">
              ...
              <input className="form-control" onChange={changeHandler} type="file" id="formFile" accept=".jpeg, .png, .jpg"/>
            </div>
